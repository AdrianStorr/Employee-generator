...
const questionList = require('./promptquestions');
const logo = require('asciiart-logo');
const mysql_db = require("../db/emsdb");
const { Console } = require("console");
class EmployeeManagement {
    constructor(questionList) {
        this.questions = questionList;
        this.db = new mysql_db("ems_db");
    ...
    async listAllEmployee() {
        let lsitOfAllEmployees = await this.db.getDataFromEmployee();
        console.table(lsitOfAllEmployees);
        this.promptMainMenu();
    }
...
const ems = new EmployeeManagement(questionList);
ems.launch();
